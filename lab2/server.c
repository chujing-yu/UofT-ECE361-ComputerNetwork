...
// only transfer one file using UDP. When file is too big, segment it into
// frags. Frag's max size: 1000 Bytes.
int main(int argc, char const *argv[]) {
  ...
  // memset(servaddr.sin_zero, 0, sizeof(servaddr.sin_zero)); //归零
